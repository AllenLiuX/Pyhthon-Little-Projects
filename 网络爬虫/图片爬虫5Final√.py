...
url = 'https://pixabay.com/en/photos/?q=trump&hp=&image_type=all&order=popular&cat=&min_width=&min_height='
...
for url in pic_url:
    ...
    try:
        ...
        print('当前图片无法下载')
        continue
    file_name = "image4/" + str(i) + ".jpg"  # 拼接图片名
    print(file_name)
    # 将图片存入本地
